...
Use the '{nameof(ObjectRelationMapper)}.{nameof(ObjectRelationMapper.AddTypeHandler)}' method to register the type and its corresponding table conversion definition.");
		}
		return Map[type];
	}
}
